...
CREATE INDEX idx_lodged_events_creature_loc ON lodged_events(creature_id, location_id);
CREATE INDEX idx_lodged_events_attack ON lodged_events(attack_id);
